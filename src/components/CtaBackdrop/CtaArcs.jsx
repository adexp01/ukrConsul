 ...
 * лінії можна було дотягнутись анімацією. Розтягується на весь бокс
 * (`preserveAspectRatio="none"`): при збереженій пропорції 1303×656 лінії
 * на широкій картці закінчувались посеред неї. Криві майже прямі, тому
 * неоднорідний масштаб не помітний. Геометрія і градієнти скопійовані
