...
const isMovableElement = (el) => {
  /*
   * Службові елементи, які рухає сам компонент, рушій не чіпає.
   *
   * Реальний випадок: у слайдері проєктів є клон фото, який переїжджає з
   * великого вікна у мініатюру. Рушій підхопив його як звичайну картинку й
   * почав анімувати opacity назустріч — заміряно, прозорість стрибала
   * 1 → 0.34 → 0.95 → 0, а переїзд обривався на півдорозі. Ознака така:
   * елемент, схований від читалок, ніколи не є контентом, який варто
   * «проявляти».
   */
