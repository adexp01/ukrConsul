 ...
 * Тому беремо лише ту дугу, де він повернутий обличчям, і йдемо нею
 * назад: від холодного 49-го до теплого 40-го — того самого ракурсу,
 * що в макеті. Виходить, що при прокрутці щит повертається до глядача.
 */
const FRAME_FIRST = 49;
const FRAME_LAST = 40;
