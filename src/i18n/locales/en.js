export const en = {
  ...
  media: {
    ...
    items: {
      ...
      sectionAria: "Media projects",
    },
    main: {
      imagePlaceholder: "Image",
      tag: "Educational format with Calibrated",
      dateLabel: "Start — June 2026",
      title: "Deftech Media Bootcamp",
      text: "An intensive educational programme for defence industry professionals, communicators and ecosystem partners who want to understand how the sector works and how to tell its story effectively.",
      accordionLabel: "During the bootcamp, participants explore:",
      accordionOpen: "Expand topics list",
      accordionClose: "Collapse topics list",
      topics: [
      ...
      textSecondary:
        "The programme combines lectures, expert meetings, case studies and practical workshops — from ecosystem overview to communication tools for manufacturers and associations.",
      apply: "Apply",
    },
    forJournalist: {
  ...
  aboutUsPage: {
    ...
    whatWeDo: {
      title: "WHAT WE DO",
      imagePlaceholder: "image",
      prevLabel: "Previous directions",
      nextLabel: "Next directions",
      items: [
        {
          id: "policy",
          icon: "cube",
  ...
  joinQuiz: {
    ...
    nextText:
      " submit a short application and the Council team will contact you about the next step.",
    submit: "Apply",
    contact: "Contact the team",
    mailSubject: "Joining the Council ecosystem",
    steps: {
      profile: {
        title: "Who are you?",
        ...
        options: [
          ...
          { id: "techTeam", label: "Technology / service team" },
          { id: "association", label: "Another association looking to join" },
          { id: "media", label: "Press / media" },
        ],
      },
      product: {
        title: "What exactly do you make?",
        text: "The segment defines which association of the ecosystem works with your field.",
        options: [
          { id: "uav", label: "UAV and aviation systems" },
          { id: "naval", label: "Naval systems" },
          { id: "ground", label: "Unmanned ground systems" },
          { id: "ew", label: "EW / SIGINT / communications" },
          { id: "armour", label: "Armour protection" },
          { id: "weapons", label: "Weapons and ammunition" },
          { id: "optics", label: "Optoelectronics / sensors" },
          { id: "software", label: "Defence-tech / software" },
          { id: "components", label: "Components / manufacturing" },
          { id: "demining", label: "Demining" },
    ...
    results: {
      defenceAlliance: {
        title: "Defence Alliance of Ukraine",
        description:
          "The broadest association of the Council ecosystem: makers of UAV and aviation systems, weapons, ammunition, defence-tech and adjacent fields.",
      },
      navalDrones: {
        title: "Unmanned Naval Association",
        description:
          "A community of developers and manufacturers of unmanned surface and underwater systems and maritime security solutions.",
      },
      roboticForces: {
        title: "Ukrainian Robotic Forces",
        description:
          "The association for unmanned ground systems: logistics and combat platforms, chassis, control and autonomy systems.",
      },
      radioelectronic: {
        title: "Radioelectronic Alliance of Ukraine",
        description:
          "The radioelectronics association: EW and SIGINT, communications, optoelectronics and sensors.",
      },
      league: {
        title: "League of Defence Companies of Ukraine",
        description:
          "An association of manufacturing companies: armour protection, components, metalworking and series production for the defence industry.",
      },
      uavSchools: {
        title: "Independent Association of UAV Schools of Ukraine",
        description:
          "A community of training centres and unmanned systems schools: training standards, joint programmes and work with the military.",
      },
      investorClub: {
        title: "UCDI Investor Club",
        description:
          "A club of private investors and funds supporting the Ukrainian defence industry.",
      },
      media: {
